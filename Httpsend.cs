...
namespace Yatse2
{
    ...
    {
        public static void HttpsendgotoHttpsimple(Yatse2.Classes.Yatse2Config _config, string url)
        {
        ...
        public static void HttpSendgotoHttp(string url, Yatse2Config _config, Plugin.ApiCurrently nowPlaying)
        {
            try
            {
