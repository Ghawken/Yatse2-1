...
namespace Yatse2
{
    public partial class Yatse2Window
    {
        private string GetMusicThumbPath(string remotepath)
        {
            ...
            Logger.Instance().Log("Yatse2", @"Missing skin image : \Interface\Default_Music-Thumbs.png", true);
            return "";
        }
        ...
        private string GetMusicFanartPath(string remotepath)
        {
            ...
            Logger.Instance().Log("Yatse2", @"Missing skin image : \Interface\Default_Music-Fanarts.png", true);
            return "";
        }
        ...
        private string GetVideoThumbPath(string remotepath)
        {
            ...
            Logger.Instance().Log("Yatse2", @"Missing skin image : \Interface\Default_Video-Thumbs.png", true);
            return "";
        }
        ...
        private string GetVideoFanartPath(string remotepath)
        {
            ...
            Logger.Instance().Log("Yatse2", @"Missing skin image : \Interface\Default_Video-Fanarts.png", true);
            return "";
        }
        ...
        { //TODO : Add parameter to change default image
            ...
            catch (Exception ex)
            {
                ...
                {
                    Logger.Instance().Log("Yatse2", "GetRandomImagePath : no images in " + path);
                    ...
                    Logger.Instance().Log("Yatse2", @"Missing skin image : \Interface\Default_Diaporama.png", true);
                    return null;
                }
                throw;
            }
        ...
        private void RefreshDictionaries()
        {
            ...
            {
                Logger.Instance().Log("Yatse2", "Error loading Dictionaries : " + e.Message, true);
                return;
            }
        }
        ...
        private ImageBrush GetSkinImageBrush(string element)
        {
            ...
            {
                Logger.Instance().Log("Yatse2", @"Skin image not found : \Interface\" + element + ".png", true);
            }
            return img;
        }
